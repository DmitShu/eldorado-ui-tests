...
@pytest.fixture()
def prec_basket_test(web_browser):
...
def test_basket_price_in_orders(prec_basket_test):
...
def test_basket_decreasing_below_1(prec_basket_test):
...
def test_basket_manual_count_input_positive(prec_basket_test):
...
def test_basket_test(prec_basket_test):
    """ Adding and removing services """
